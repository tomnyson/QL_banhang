...
function make_wyzz(textareaID) {
  ...
  var toolbar;
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar" style="width:' + toolbarWidth + 'px; background:#fdfce1;"><tr>';
  ...
  var iframe = '<table style="background:#f9fdff;" cellpadding="0" cellspacing="0" border="0" style="width:' + wyzzW + 'px; height:' + wyzzH + 'px;border: 1px inset #CCCCCC;"><tr><td valign="top">\n'
